...
type ReceivedContext struct {
	...
	ReferredProduct     *ReferredProduct `json:"referred_product,omitempty"` // Referred product object describing the product the user is requesting information about. You must parse this value if you support Product Enquiry Messages.
}
